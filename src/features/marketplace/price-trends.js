// price-trends.js — Price history tracking and trend visualization (ES Module)
...
function addPriceAlert(cardNumber, heroName, targetPrice, direction) {
  ...
  if (alerts.find(a => a.cardNumber === cardNumber && a.direction === direction)) {
    showToast('Alert already exists', '⚠️');
    return;
  }
  alerts.push({
    cardNumber,
      ...
      <div class="modal-content" style="max-width:400px;">
        ...
        <div class="modal-body" style="padding:20px;">
          <p style="color:#94a3b8;font-size:13px;margin:0 0 12px;">
            Get notified when <strong>${escapeHtml(heroName || cardNumber)}</strong>
...
export { recordPrice, renderPriceTrendChart, showPriceAlertModal, addPriceAlert, getPriceAlerts };
