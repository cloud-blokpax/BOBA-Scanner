<script lang="ts">
	...
	import GamesStrip from '$lib/components/home/GamesStrip.svelte';
...
<div class="dashboard">
	{#if data.user}
		...
		<div class="block-entrance" style="animation-delay: 120ms"><GamesStrip /></div>
		<div class="block-entrance" style="animation-delay: 180ms"><TournamentCodeEntry /></div>
		<div class="block-entrance" style="animation-delay: 240ms"><QuickActionsGrid /></div>
	{:else}
