...
export const TOURNAMENT_FORMATS: FormatRules[] = [
	...
	},
	{
		...
		description: 'Combined Power format: 8,250 total power cap across all Heroes. No individual SPEC cap. Starter cards allowed. Active sideboard with unlimited bonus plays.',
		gameMode: 'playmaker',
		isTeamFormat: false,
		heroDeckMin: 60,
		heroDeckMax: null,
	...
	},
	{
		...
		description: 'Only Silver and Headline Battlefoils (at least 20 of each). No Bonus Plays. No power cap — Steel weapon dominant. Active sideboard of up to 45 plays.',
		gameMode: 'playmaker',
		isTeamFormat: false,
		heroDeckMin: 60,
		heroDeckMax: null,
