		...
		Tables: {
			...
			scan_sessions: {
				Row: {
					...
					page_session_age_ms: number | null;
			...
			scans: {
				Row: {
					...
					outcome: 'pending' | 'auto_confirmed' | 'user_confirmed' | 'user_corrected' | 'disputed' | 'abandoned' | 'timeout' | 'low_quality_rejected' | 'resolved';
					...
					exif_gps_stripped: boolean | null;
					camera_facing: 'user' | 'environment' | null;
					torch_on: boolean | null;
					focus_mode: string | null;
					device_orientation_beta: number | null;
					device_orientation_gamma: number | null;
					accel_magnitude: number | null;
					blur_laplacian_variance: number | null;
					luminance_mean: number | null;
					luminance_std: number | null;
					overexposed_pct: number | null;
					underexposed_pct: number | null;
					edge_density_canny: number | null;
					card_area_pct: number | null;
					perspective_skew_deg: number | null;
					quality_gate_passed: boolean | null;
					quality_gate_fail_reason: string | null;
					decision_context: Record<string, unknown>;
					live_consensus_reached: boolean | null;
					live_vs_canonical_agreed: boolean | null;
					fallback_tier_used: 'none' | 'haiku' | 'sonnet' | 'manual' | null;
					winning_tier: string | null;
					final_card_id: string | null;
					final_confidence: number | null;
					final_parallel: string | null;
			...
			scan_tier_results: {
				Row: {
					...
					schema_version: number;
					created_at: string;
					topn_candidates: Array<Record<string, unknown>> | null;
					idb_cache_hit: boolean | null;
					sb_exact_hit: boolean | null;
					sb_fuzzy_hit: boolean | null;
					winner_dhash_distance: number | null;
					winner_phash_distance: number | null;
					runner_up_margin_dhash: number | null;
					hash_match_count: number | null;
					query_dhash: string | null;
					query_phash_256: string | null;
					...
					llm_model_responded: string | null;
					llm_input_tokens: number | null;
					llm_output_tokens: number | null;
					llm_cache_creation_tokens: number | null;
					llm_cache_read_tokens: number | null;
					llm_finish_reason: string | null;
					pricing_table_version: string | null;
					prompt_template_sha: string | null;
					prompt_template_version: string | null;
					claude_returned_name_in_catalog: boolean | null;
					outcome: string | null;
			...
			scan_claude_responses: {
				Row: {
					id: string;
					tier_result_id: string;
					scan_id: string;
					user_id: string;
				...
				Update: Partial<Database['public']['Tables']['scan_claude_responses']['Insert']>;
				Relationships: [];
			};
			scan_resolutions: {
				Row: {
